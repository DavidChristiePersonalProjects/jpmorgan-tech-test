...
public class TradesManager {
     ...
     * @return List object containing a sorted list of Trade objects
     */
    ...
    /**
     * Set the settlement date for all Trade objects 
     */
     ...
     * @param trade the Trade object to have its settlement date adjusted
     */
